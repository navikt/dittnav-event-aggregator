...
import no.nav.personbruker.dittnav.eventaggregator.expired.ExpiredNotificationProcessor
...
class ApplicationContext {
    ...
    private fun initializeExpiredBeskjedProcessor() = ExpiredNotificationProcessor(expiredPersistingService, doneEventEmitter)
